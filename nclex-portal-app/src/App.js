// src/App.js - FIXED to move Router to the top level
...
// ✅ Router content component (with routes)
function RouterContent() {
  ...
  useEffect(() => {
    // ✅ Clear any conflicting auth states on app start
    const authToken = localStorage.getItem('authToken');
    const guestMode = localStorage.getItem('guestMode');
    
    // If we have an auth token, we're not a guest
...
// ✅ Main App component - Provider and Router wrapper
function App() {
  return (
